...
def call_model(model_choice: str, prompt_choice: str, placeholders: dict) -> str:
    ...
    if model_choice == '3':
        ...
        if API_TOKEN is None:
            raise ValueError("Set your Hugging Face API token in HF_API_TOKEN")

        # Initialize the client for Tülu 3
        inference = InferenceApi(
            repo_id="allenai/Llama-3.1-Tulu-3.1-8B",
            token=API_TOKEN
        )
        ...
        print(res)
        return res[0]['generated_text']['content']
